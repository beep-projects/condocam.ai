...
"""Script to test object detection based on given PROTOTXT and CAFFEEMODEL.
This script was used to develop condocam_image_watchdog.py
"""
...
for imagePath in paths.list_images(args["folder"]):
  ...
  print(f"--- detection duration {(time.time() - start_time)} seconds ---")
